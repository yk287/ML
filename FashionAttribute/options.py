...
class options():
    ...
    def initialize(self):
        ...
        # Training Options
        self.parser.add_argument('--epoch', type=int, nargs='?', default=750, help='total number of training episodes')
        ...
        self.parser.add_argument('--lr', type=int, nargs='?', default=0.0002, help='learning rate')
        ...
        self.parser.add_argument('--num_classes', type=int, nargs='?', default=8, help='number of classes')

        # Image
        self.parser.add_argument('--resize', type=int, nargs='?', default=32, help='Image Resize size')
